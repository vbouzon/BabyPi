...
var Server = (function () {
    function Server() {
        ...
        this.get_feed = function () {
            return child.spawn('raspivid', ['--nopreview', '-ih', '-t', '0', '-o', '-', '-w', _this.options.width.toString(), '-h', _this.options.height.toString(), '-fps', _this.options.fps.toString()], { stdio: ['ignore', 'pipe', 'ignore'] }).stdout;
        };
